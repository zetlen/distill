...
/** @deprecated Use resolveSignal instead */
export const resolveProjection = resolveSignal
/** @deprecated Use resolveWatch instead */
export const resolveFocus = resolveWatch
/** @deprecated Use resolveReport instead */
export const resolveViewer = resolveReport
